...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCCharts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCCharts-1.0.0-beta+20230314121632.xcframework.zip",
			checksum: "a0122d5dfa685c1ae6576a7659bbc8a64bbfc3b6bd2527f0f4a67769afdf4490"
		)
	]
)