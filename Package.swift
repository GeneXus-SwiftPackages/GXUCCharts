...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCCharts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCCharts-1.0.0-beta+20230524184838.xcframework.zip",
			checksum: "efd6c63d722fe37b01009a8a0be9ca25e27142296174414791fd50c57ae5060a"
		)
	]
)