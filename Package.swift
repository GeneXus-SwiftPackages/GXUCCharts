...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCCharts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCCharts-1.0.0-beta+20230525122919.xcframework.zip",
			checksum: "485f59836a986b9459987bde857f711c8efac50dbda23838cf4223633d67e3b5"
		)
	]
)