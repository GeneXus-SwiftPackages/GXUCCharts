...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCCharts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCCharts-1.0.0-beta+20230509131236.xcframework.zip",
			checksum: "83a4a8d2a4fbee5a80259b99fef8f6b4b874e04c15a828bab75ff5fd8e4a4553"
		)
	]
)