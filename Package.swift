...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCCharts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCCharts-1.0.0-beta.20230704143346.xcframework.zip",
			checksum: "819ef3396b98461585753265217a91c3f6a2e916eebd3fdad67b912d9bf20bd0"
		)
	]
)