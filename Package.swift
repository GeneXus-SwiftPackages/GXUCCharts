...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCCharts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCCharts-1.0.0-beta+20230405133406.xcframework.zip",
			checksum: "63b696a7b4fa3daa7fa8669a4af66327b7e6be021cdd0f9a0b99dfc6c5e2e2ff"
		)
	]
)