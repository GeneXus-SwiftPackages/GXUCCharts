...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCCharts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCCharts-1.0.0-beta+20230315133647.xcframework.zip",
			checksum: "012b626bb4a9eda4f0ec22e9b971ebd12622dd1428bdbf49707eee7ba0cc0e2f"
		)
	]
)