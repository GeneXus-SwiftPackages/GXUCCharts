...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCCharts",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCCharts-1.1.0-rc.1.xcframework.zip",
			checksum: "49e98367fcb43bdc3b5aae2cb63ffe2a93dd240f41cb06e2075922ae6a319ea6"
		)
	]
)