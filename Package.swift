...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCCharts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCCharts-1.1.0-beta.794.xcframework.zip",
			checksum: "ab82c5ad3aafe3fbf69fff5f436d860e666c6de5a7984354d7c9db9ea3866d20"
		)
	]
)