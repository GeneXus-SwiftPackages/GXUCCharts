...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCCharts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCCharts-1.0.0-beta+20230323104412.xcframework.zip",
			checksum: "9092c8ddd0c225d2b0fde523e04bc2ebcca84bc020f33e8b32579c5077be4338"
		)
	]
)