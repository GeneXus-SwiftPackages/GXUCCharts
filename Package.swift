...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCCharts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCCharts-1.0.0-beta+20230306150353.xcframework.zip",
			checksum: "8578b132eb9115c05b198dab1aab56aa80f27fcdc0ebace33b1e324575addfe3"
		)
	]
)