...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCCharts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCCharts-1.0.0-beta+20230327200102.xcframework.zip",
			checksum: "c63514de5800c8c4aa177656f16998858994c43f172e0fa2e078e408bbaba085"
		)
	]
)