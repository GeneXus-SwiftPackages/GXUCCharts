...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCCharts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCCharts-1.0.0-beta+20230220183523.xcframework.zip",
			checksum: "aa857da0283f535b82c7ce381049a15d0ac0aaedb85dd330d5568c43c0ba9a09"
		)
	]
)