...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCCharts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCCharts-1.0.0-beta+20230519182256.xcframework.zip",
			checksum: "f31b518bae62a77ca81a5afbc7b9adbb4a7f0db8cb44b949967c67a0e933afec"
		)
	]
)