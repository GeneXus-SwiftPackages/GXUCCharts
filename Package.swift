...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCCharts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCCharts-1.0.0-beta+20230503140111.xcframework.zip",
			checksum: "0193456647c351c5e925c4adb06173a56f4969607de8d84d44d43a59c8ef50b4"
		)
	]
)