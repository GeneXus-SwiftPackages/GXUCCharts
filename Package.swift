...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCCharts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCCharts-1.0.0-beta.20230710193719.xcframework.zip",
			checksum: "2b885affaad35214c521050a7e10a77dd400948e982c5a714045a1c1d3e21026"
		)
	]
)