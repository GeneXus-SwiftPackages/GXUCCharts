...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCCharts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCCharts-1.0.0-beta+20230515145153.xcframework.zip",
			checksum: "3a1289e2e0776514d381421b7b4d98dab7f2fafdeebdc07bbe0a3ce27ad315c5"
		)
	]
)