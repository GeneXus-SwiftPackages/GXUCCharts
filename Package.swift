...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCCharts",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCCharts-1.0.0-beta+20230515023341.xcframework.zip",
			checksum: "de1d055e9dadafc13b49c825cfae41ce694e3943c76b67c07f32bad400feeca1"
		)
	]
)